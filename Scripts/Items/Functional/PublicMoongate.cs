...
namespace Server.Items
{
    ...
    public class PMList
    {
        ...
        public static readonly PMList[] SEListsYoung = new PMList[] { Ilshenar, Malas, Tokuno };
        public static readonly PMList[] SALists    = new PMList[] { Felucca, Ilshenar, Malas, Tokuno };
        public static readonly PMList[] SAListsYoung = new PMList[] { Ilshenar, Malas, Tokuno };
